...
elseif((_IREE_UNNORMALIZED_ARCH_LOWERCASE STREQUAL "mips64") OR
       (_IREE_UNNORMALIZED_ARCH_LOWERCASE STREQUAL "mips64el"))
  set(IREE_ARCH "mips_64")
...
function(iree_arch_to_llvm_arch DST_LLVM_ARCH_VARIABLE SRC_ARCH)
  ...
  elseif("${SRC_ARCH}" STREQUAL "mips_64")
    set(${DST_LLVM_ARCH_VARIABLE} "mips64el" PARENT_SCOPE)
  else()
...
function(iree_arch_to_llvm_target DST_LLVM_TARGET_VARIABLE SRC_ARCH)
  ...
  elseif("${SRC_ARCH}" MATCHES "^mips_")
    set(${DST_LLVM_TARGET_VARIABLE} "Mips" PARENT_SCOPE)
  else()
...
function(iree_compile_flags_for_platform OUT_FLAGS IN_FLAGS)
  ...
  elseif(IREE_ARCH STREQUAL "mips_64" AND
       CMAKE_SYSTEM_NAME STREQUAL "Linux" AND
       NOT IN_FLAGS MATCHES "iree-llvmcpu-target-triple")
  list(APPEND _FLAGS ${MIPS64_TEST_DEFAULT_LLVM_FLAGS})
  endif()
