...
set(CMAKE_SYSTEM_PROCESSOR riscv64) # ciljna arhitektura = riscv 64-bit

if(NOT "${RISCV_TOOLCHAIN_ROOT}" STREQUAL "")   #ako je definisana environment var za riscv toolchain
  ...
  set(CMAKE_SYSROOT "${RISCV_TOOLCHAIN_ROOT}/sysroot") #root fajl sistem za target
  ...
  # strip debug info iz libgcc da bi lld mogao da parsra (riscv problem ?)
...
set(RISCV64_TEST_DEFAULT_LLVM_FLAGS
  ...
  "--iree-llvmcpu-target-cpu-features=+m,+a,+f,+d,+c,+zvl512b,+v" # multiply, atomic, float, double, compressed
