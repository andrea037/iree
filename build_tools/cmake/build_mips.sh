...
args=(
  ...
  # ovo je dodato van guide-a
  #"-DIREE_EXTERNAL_DEPS_DISABLE_IO_URING=ON" -> ovo ne postoji
  ...
  "-DIREE_TARGET_BACKEND_LLVM_CPU=OFF" #off za fazu 1
